 ...
 * Fields
 */
$GLOBALS['TL_LANG']['tl_forum_settings']['forum_redirect_settings'] = 'Redirect settings';
$GLOBALS['TL_LANG']['tl_forum_settings']['forum_redirect_threadreader'] = array('Thread reader', 'Page containing the thread reader');
$GLOBALS['TL_LANG']['tl_forum_settings']['forum_redirect_threadeditor'] = array('Thread editor', 'Page containing the thread editor');

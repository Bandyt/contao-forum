 ...
 * Buttons
 */
$GLOBALS['TL_LANG']['tl_forum_forums']['new']    = array('Neues Forum', 'Forum hinzuf&uuml;gen');
$GLOBALS['TL_LANG']['tl_forum_forums']['edit']   = array('Forum bearbeiten', 'Forum bearbeiten');
$GLOBALS['TL_LANG']['tl_forum_forums']['copy']   = array('Forum kopieren', 'Forum kopieren');
$GLOBALS['TL_LANG']['tl_forum_forums']['delete'] = array('Forum l&ouml;schen', 'Forum l&ouml;schen');
$GLOBALS['TL_LANG']['tl_forum_forums']['show']   = array('Forum anzeigen', 'Forum anzeigen');
